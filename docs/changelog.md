...
## [2025-06-07] - Внедрение Helmet для SEO
### Добавлено
...
## [2024-06-08] - Централизация рекламы через AdSlot и ads-config
### Изменено
- На странице FAQ удалён прямой вызов рекламного блока Яндекса, теперь используется только универсальный компонент <AdSlot slot="footer" />
- Вся реклама теперь управляется через ads-config.tsx, нет дублирования кода и стилей

### Исправлено
- Удалён устаревший div с id yandex_rtb_R-A-15762893-1 и прямой вызов <YandexAds blockId="..." />